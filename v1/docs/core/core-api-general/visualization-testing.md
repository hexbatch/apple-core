...
Often in building and testing, its good to see a visual representation of the total state of the system

Here we can call the api to get all the json of all resources seen by a user: bounds, type, attributes, scripts, remotes, types, tokens, sets, mutuals, interfaces, pipes
